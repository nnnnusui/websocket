...
data class Channel(
 ...
 ,@SerialName("topic"                ) @Optional val topic:                String?          = null // nullable
 ...
 ,@SerialName("bitrate"              ) @Optional val bitrate:              Int?             =null
 ...
 ,@SerialName("recipients"           ) @Optional val recipients:           Array<User>?     =null
 ,@SerialName("icon"                 ) @Optional val icon:                 String?          = null // nullable
