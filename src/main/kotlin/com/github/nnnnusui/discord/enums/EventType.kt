...
import com.github.nnnnusui.discord.event.difftodocs.PresenceReplace
import com.github.nnnnusui.discord.event.presence.PresenceUpdate
import com.github.nnnnusui.discord.event.presence.TypingStart
import com.github.nnnnusui.discord.event.presence.UserUpdate
import kotlinx.serialization.KSerializer

// @formatter:off
enum class EventType(val serializer: KSerializer<out IsGatewayEvent>){
    HELLO( Hello.serializer())
   /* Not listed in the docs.                                       */
   ,PRESENCE_REPLACE(           PresenceReplace         .serializer())
   /* ------------------------------------------------------------- */
